...
public class SetSummaryFields {

	private Integer id_sku_bundle_sets;
	private String discount_applicable_on;
	private String operator;
	private Integer quantity;

	public Integer getId_sku_bundle_sets() {
		return id_sku_bundle_sets;
	}

	public void setId_sku_bundle_sets(Integer id_sku_bundle_sets) {
		this.id_sku_bundle_sets = id_sku_bundle_sets;
	}
